...
v0.2.0-alpha.5 - The First Breath
...
현재 Mock Provider와 OpenAI Provider가 공존합니다. 기본값은 안전하게 `mock`입니다.
...
ChatProvider     -> MockChatProvider / OpenAIProvider
EventBus         -> EventBus
