"""Run Google OAuth for Jarvis Google Contacts access."""
...
def main():
    """Authorize Google Calendar write plus Contacts read/write access."""
    ...
    print(f"Google Contacts auth status: {status.status.value}")
    return 0
